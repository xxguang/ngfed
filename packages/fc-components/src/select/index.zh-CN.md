...
<!-- ### 搜索框（略） -->
<!-- <code src="./demo/base10.tsx"></code> -->

### 获得选项的文本
<code src="./demo/base11.tsx"></code>

### 自动分词
<code src="./demo/base12.tsx"></code>

<!-- ### 搜索用户（略） -->
<code src="./demo/base13.tsx"></code>

### 扩展菜单
<code src="./demo/base14.tsx"></code>


### 隐藏已选择选项
<code src="./demo/base15.tsx"></code>

### 无边框
<code src="./demo/base16.tsx"></code>

### 自定义选择标签
<code src="./demo/base17.tsx"></code>
